...
public protocol URLTaskReactor : TaskReactor {
    func shouldExecute(after: URLTask.Result, from: URLTask, with: TaskHandle) -> Bool
}
...
public extension URLTaskReactor {
     ...
     */
    func shouldExecute<T: Task>(after result: T.Result, from task: T, with handle: TaskHandle) -> Bool {
